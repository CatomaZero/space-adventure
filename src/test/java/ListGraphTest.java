...
public class ListGraphTest extends TestCase {
    private ListGraph<Integer> matrixGraph;

    public void setUpStage1() {
        matrixGraph = new ListGraph<>();
    }
    ...
    public void testDijkstra3() {
        setUpStage7();
        assertEquals("null", Arrays.toString(matrixGraph.dijkstra(10)));
    }
    ...
    public void testPrim1(){
        ...
        String result = "(0, 1)   Weight: 2.0\n" +
                ...
                "(1, 4)   Weight: 5.0\n" +
                "(0, 3)   Weight: 6.0";
        assertEquals(result, matrixGraph.primMST(0,100));
    }
